            ...
            >
              <div className="flex flex-col md:flex-row gap-8">
                <div className="flex-shrink-0">
                  <div className="mb-4"><archetype.Icon size={64} className="text-node-volt" /></div>
        ...
        <div className="bg-gradient-to-r from-node-volt/20 via-node-volt/10 to-concrete-grey border-2 border-node-volt rounded-xl p-12 text-center">
          ...
          <div className="flex flex-wrap justify-center gap-4">
            <Link
              ...
              className="bg-node-volt text-dark font-bold px-8 py-4 rounded-xl hover:opacity-90 transition-opacity text-lg"
